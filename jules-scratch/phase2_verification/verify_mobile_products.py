...
async def main():
    async with async_playwright() as p:
        ...
        try:
            ...
            # Take a screenshot
            screenshot_path = "jules-scratch/phase2_verification/mobile_products_before.png"
            await page.screenshot(path=screenshot_path)
            print(f"Screenshot saved to {screenshot_path}")

        except Exception as e:
            print(f"❌ An error occurred: {e}")
            await page.screenshot(path="jules-scratch/phase2_verification/mobile_products_error.png")
        finally:
            await browser.close()
