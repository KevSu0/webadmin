    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto text-base sm:text-xl md:text-2xl mb-8 text-blue-100">
              Professional cameras, lenses, and accessories for photographers of all levels.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/products"
                className="w-full sm:w-auto bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block text-base sm:text-lg"
              >
                Shop Now
              </Link>
              <Link
                to="/products?condition=secondhand"
                className="w-full sm:w-auto border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors inline-block text-base sm:text-lg"
              >
                Browse Used Gear
              </Link>
            </div>
            ...
            {['Cameras', 'Lenses', 'Accessories', 'Used Gear'].map((category) => (
              ...
              >
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <p className="text-gray-600 text-sm mt-1">Explore</p>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="py-12 md:py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base md:text-xl mb-8 text-blue-100 max-w-3xl mx-auto">
            Browse our extensive collection of cameras, lenses, and accessories.
          </p>
          <Link
            to="/products"
            className="w-full sm:w-auto bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block text-base sm:text-lg"
          >
            View All Products
          </Link>
        </div>
